...
public class Main2Activity extends AppCompatActivity {
   ...
   int qn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (h.equals("img1")) {
            i1.setImageResource(R.drawable.andriodpic5);
            cursor = database.rawQuery("SELECT ItemID,Name,Price,Code FROM Item_Info", null);
            while (cursor.moveToNext()) {
                String s = cursor.getString(0);
            ...
            i1.setImageResource(R.drawable.androidpic2);
            cursor = database.rawQuery("SELECT ItemID,Name,Price,Code FROM Item_Info", null);
            while (cursor.moveToNext()) {
                String s = cursor.getString(0);
        ...
        {
            i1.setImageResource(R.drawable.andriodpic4);
            cursor = database.rawQuery("SELECT ItemID,Name,Price,Code FROM Item_Info", null);
            while (cursor.moveToNext()) {
                String s = cursor.getString(0);
        ...
        {
            i1.setImageResource(R.drawable.andriodpic6);
            cursor = database.rawQuery("SELECT ItemID,Name,Price,Code FROM Item_Info", null);
            while (cursor.moveToNext()) {
                String s = cursor.getString(0);
        ...
        {
            i1.setImageResource(R.drawable.andriodpic1);
            cursor = database.rawQuery("SELECT ItemID,Name,Price,Code FROM Item_Info", null);
            while (cursor.moveToNext()) {
                String s = cursor.getString(0);
        ...
        {
            i1.setImageResource(R.drawable.andriodpic3);
            cursor = database.rawQuery("SELECT ItemID,Name,Price,Code FROM Item_Info", null);
            while (cursor.moveToNext()) {
                String s = cursor.getString(0);
        ...
        {
            i1.setImageResource(R.drawable.andriodpic7);
            cursor = database.rawQuery("SELECT ItemID,Name,Price,Code FROM Item_Info", null);
            while (cursor.moveToNext()) {
                String s = cursor.getString(0);
        ...
        {
            i1.setImageResource(R.drawable.andriodpic8);
            cursor = database.rawQuery("SELECT ItemID,Name,Price,Code FROM Item_Info", null);
            while (cursor.moveToNext()) {
                String s = cursor.getString(0);
